    ...
    <div class="modal-content">
      ...
      <div class="row justify-content-enter" >
            ...
            <input type="hidden" name="id" value="<?php echo$id ?>">
                ...
                <select name="department" id="" style="width: 250px;">
            ...
            foreach ($rows as $row) {
                print "<option value='" . $row['departmentName'] . "'>" . $row['departmentName'] . "</option>";
            }
            ?>
        </select>
                </div>
            ...
            foreach ($rows as $row) {
                print "<option value='" . $row['positionName'] . "'>" . $row['positionName'] . "</option>";
            }
            ?>
        </select>
                </div>
